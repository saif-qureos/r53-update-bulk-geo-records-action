...
const L = "type", M = "fn", N = "argv", O = "ref", P = "url", Q = "properties", R = "headers", S = "authSchemes", T = "name", U = "signingRegion", V = "signingName";
const a = true, b = false, c = "String", d = "PartitionResult", e = "tree", f = "error", g = "endpoint", h = "stringEquals", i = "https://route-53-fips.{Region}.api.aws", j = "https://route-53.{Region}.api.aws", k = { "required": true, "default": false, [L]: "Boolean" }, l = { [O]: "Region" }, m = { [O]: "Endpoint" }, n = {}, o = { [M]: "getAttr", [N]: [{ [O]: d }, "name"] }, p = { [S]: [{ [T]: "sigv4", [U]: "us-east-1", [V]: "route53" }] }, q = { [f]: "FIPS and DualStack are enabled, but this partition does not support one or both", [L]: f }, r = { [P]: "https://route53-fips.amazonaws.com", [Q]: p, [R]: {} }, s = { [f]: "FIPS is enabled but this partition does not support FIPS", [L]: f }, t = { [f]: "DualStack is enabled but this partition does not support DualStack", [L]: f }, u = { [P]: "https://route53.amazonaws.com", [Q]: p, [R]: {} }, v = { [S]: [{ [T]: "sigv4", [U]: "cn-northwest-1", [V]: "route53" }] }, w = { [P]: "https://route53.amazonaws.com.cn", [Q]: v, [R]: {} }, x = { [S]: [{ [T]: "sigv4", [U]: "us-gov-west-1", [V]: "route53" }] }, y = { [g]: { [P]: "https://route53.us-gov.amazonaws.com", [Q]: x, [R]: {} }, [L]: g }, z = { [S]: [{ [T]: "sigv4", [U]: "us-iso-east-1", [V]: "route53" }] }, A = { [P]: "https://route53.c2s.ic.gov", [Q]: z, [R]: {} }, B = { [S]: [{ [T]: "sigv4", [U]: "us-isob-east-1", [V]: "route53" }] }, C = { [P]: "https://route53.sc2s.sgov.gov", [Q]: B, [R]: {} }, D = { "conditions": [{ [M]: h, [N]: [l, "aws-us-gov-global"] }], [g]: { [P]: "https://route53.us-gov.amazonaws.com", [Q]: x, [R]: {} }, [L]: g }, E = [{ [M]: "booleanEquals", [N]: [{ [O]: "UseFIPS" }, true] }], F = [{ [M]: "booleanEquals", [N]: [{ [O]: "UseDualStack" }, true] }], G = [{ [M]: "booleanEquals", [N]: [{ [O]: "UseFIPS" }, true] }, { [M]: "booleanEquals", [N]: [{ [O]: "UseDualStack" }, true] }], H = [{ [M]: "booleanEquals", [N]: [true, { [M]: "getAttr", [N]: [{ [O]: d }, "supportsFIPS"] }] }, { [M]: "booleanEquals", [N]: [true, { [M]: "getAttr", [N]: [{ [O]: d }, "supportsDualStack"] }] }], I = [{ [M]: "booleanEquals", [N]: [true, { [M]: "getAttr", [N]: [{ [O]: d }, "supportsFIPS"] }] }], J = [{ [M]: "booleanEquals", [N]: [true, { [M]: "getAttr", [N]: [{ [O]: d }, "supportsDualStack"] }] }], K = [{ [M]: h, [N]: [l, "aws-global"] }];
